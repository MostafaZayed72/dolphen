<template>
    <v-container>
      ...
      <v-row>
        <v-col cols="12" md="4">
          <v-card>
            <v-card-title>إضافة عرض جديد</v-card-title>
            <v-card-text>
        ...
        <v-col cols="12" md="4">
          <v-card>
            <v-card-title>تعديل عرض موجود</v-card-title>
            <v-card-text>
              <v-select v-model="selectedQuestion" :items="questions" label="اختر العرض"></v-select>
        ...
        <v-col cols="12" md="4">
          <v-card>
            <v-card-title>حذف عرض موجود</v-card-title>
            <v-card-text>
              <v-select v-model="selectedQuestionToDelete" :items="questions" label="اختر العرض"></v-select>
